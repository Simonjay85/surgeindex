...
export const metadata: Metadata = {
  ...
  openGraph: { title: "SurgeIndex — the live leaderboard of internet attention", description: "Earn attention. Keep the rank honest.", type: "website", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "SurgeIndex — the live leaderboard of internet attention" }] },
