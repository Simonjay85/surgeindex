...
export function SubmitForm() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setState("success");
    setMessage(`${domain} was submitted successfully. Metadata was imported server-side and the listing is ${status === "pending" || status === "pending_review" ? "pending moderation" : status.replaceAll("_", " ")}.`);
  }
