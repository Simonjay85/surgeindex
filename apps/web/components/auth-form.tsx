...
export function AuthForm({ isDemo, nextPath = "/dashboard", googleEnabled = false }: { isDemo: boolean; nextPath?: string; googleEnabled?: boolean }) {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch(endpoint, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ name: name.trim(), email: email.trim(), password, callbackURL: nextPath }) });
