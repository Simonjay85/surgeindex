...
const transitions: Record<BoostCampaignState, readonly BoostCampaignState[]> = {
  ...
  pending_payment: ["payment_processing", "paid", "payment_failed", "checkout_expired"],
  payment_processing: ["paid", "payment_failed", "checkout_expired"],
  paid: ["scheduled", "active", "paid_pending_inventory_review", "cancel_requested", "refund_pending", "disputed"],
  paid_pending_inventory_review: ["scheduled", "active", "refund_pending", "cancel_requested", "disputed"],
  scheduled: ["active", "paused", "cancel_requested", "refund_pending", "disputed", "suspended"],
